...
import { FaUser, FaEnvelope, FaLock, FaIdBadge, FaBuilding, FaUserPlus } from 'react-icons/fa';
...
function Register() {
  const [formData, setFormData] = useState({
    ...
    employeeId: '',
    department: '',
    role: 'employee', // ✅ send default role to backend
  });
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    // ✅ formData already has name, email, password, employeeId, department, role
